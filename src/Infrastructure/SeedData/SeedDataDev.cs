...
public static class SeedDataDev
{
    public static void Initialize()
    {
        ...
        sensors.Add(new Sensor(1, "Sensor 1", "", "sensors/sensor1", 0, 550, "cm", 24, "group 1", 1));
        sensors.Add(new Sensor(2, "Sensor 2", "", "sensors/sensor2", 0, 550, "cm", 24, "group 1", 1));
        sensors.Add(new Sensor(3, "Sensor 3", "", "sensors/sensor3", 0, 550, "cm", 24, "group 2", 1));
        sensors.Add(new Sensor(4, "Sensor 4", "", "sensors/sensor4", 0, 550, "cm", 24, "group 3", 1));
